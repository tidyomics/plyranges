...
In `plyranges` this is termed an inner overlap join:
```{r}
...
To maintain the original features of exons on the intersect ranges, we can
perform a `left_join` on the overlapped ranges object with the exons
