...
#' @export
slice_head.Ranges <- function(.data, ..., n, prop, .preserve = FALSE) {
...
#' @export
slice_head.GroupedGenomicRanges <- function(.data, ..., n, prop,
                                            .preserve = FALSE) {
  apply_grouped_slice(
    .data,
...
#' @export
slice_tail.Ranges <- function(.data, ..., n, prop, .preserve = FALSE) {
...
#' @export
slice_tail.GroupedGenomicRanges <- function(.data, ..., n, prop,
                                            .preserve = FALSE) {
  apply_grouped_slice(
    .data,
    function(grp_size) head_tail_index(grp_size, n = n, prop = prop,
...
#' @export
slice_sample.Ranges <- function(.data, ..., n, prop, weight_by = NULL,
                                replace = FALSE, .preserve = FALSE) {
  total   <- length(.data)
...
#' @export
slice_sample.GroupedGenomicRanges <- function(.data, ..., n, prop,
                                              weight_by = NULL,
                                              replace = FALSE,
                                              .preserve = FALSE) {
...
#' @export
slice_min.Ranges <- function(.data, order_by, n, prop, with_ties = TRUE,
                             .preserve = FALSE) {
...
#' @export
slice_min.GroupedGenomicRanges <- function(.data, order_by, n, prop,
                                           with_ties = TRUE,
                                           .preserve = FALSE) {
  order_quo <- rlang::enquo(order_by)
...
#' @export
slice_max.Ranges <- function(.data, order_by, n, prop, with_ties = TRUE,
                             .preserve = FALSE) {
  order_quo <- rlang::enquo(order_by)
  inx <- minmax_index(.data, order_quo, n = n, prop = prop,
...
#' @export
slice_max.GroupedGenomicRanges <- function(.data, order_by, n, prop,
                                           with_ties = TRUE,
                                           .preserve = FALSE) {
  order_quo <- rlang::enquo(order_by)
  apply_grouped_minmax(.data, order_quo, n = n, prop = prop,
...
resolve_n_prop <- function(total, n, prop, replace = FALSE) {
  ...
  if (missing(n)) stop("One of `n` or `prop` must be supplied.")
  n <- as.integer(n)
  if (!replace && n > total) {
...
head_tail_index <- function(total, n, prop, from_head) {
...
minmax_index <- function(.data, order_quo, n, prop, with_ties, decreasing) {
...
apply_grouped_minmax <- function(.data, order_quo, n, prop, with_ties,
                                 decreasing) {
  col_name <- rlang::as_name(order_quo)
  rng      <- .data@delegate
  grp_rows <- .group_rows(.data)
