...
#' @rdname overlap-joins
#' @export
join_overlap_inner.IntegerRanges <- function(x, y, maxgap = -1L, minoverlap = 0L, suffix = c(".x", ".y")) {
...
#' @rdname overlap-joins
#' @export
join_overlap_inner_within.IntegerRanges <- function(x, y, maxgap = -1L, minoverlap = 0L, suffix = c(".x", ".y")) {
