...
common classes, _IRanges_, _GRanges_ and _SummarizedExperiment_ 
(not yet implemented). 
...
See the [introduction vignette](http://stuartlee.org/plyranges/articles/01-introduction-plyranges.html) for an
overview of `plyranges` features. For mapping between `plyranges`, `bedtools`
and `GenomicRanges` see the [data wrangling vignette](http://stuartlee.org/plyranges/articles/02-bedtools-examples.html).
