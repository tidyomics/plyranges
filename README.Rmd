...
See the [introduction vignette](vignettes/introduction-plyranges.md) for an
overview of `plyranges` features. For mapping between `plyranges`, `bedtools`
and `GenomicRanges` see the [data wrangling vignette](vignettes/bedtools-examples.md).
