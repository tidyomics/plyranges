...
For mapping between the `plyranges`, `bedtools`
and `GenomicRanges` packages read the [API comparision vignette](https://sa-lee.github.io/plyranges/articles/comparision.html).
