...
See the [introduction vignette](articles/introduction-plyranges.md) for an
overview of `plyranges` features. For mapping between `plyranges`, `bedtools`
and `GenomicRanges` see the [data wrangling vignette](articles/bedtools-examples.md).
