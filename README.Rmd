...
The package is currently on the development branch of Bioconductor
and will become available in the next release in May. To install the 
...
A version for R (>= 3.4.2) is available to install via github with the following code:
```{r, eval=FALSE}
source("https://bioconductor.org/biocLite.R")
