...
- filter regions by percentage overlap
- compute coverage and related summaries

The examples and and exercises follow the [HelloRanges package tutorial](http://bioconductor.org/packages/release/bioc/vignettes/HelloRanges/inst/doc/tutorial.pdf).
...
This tutorial is aimed at the beginner/intermediate R user. 
