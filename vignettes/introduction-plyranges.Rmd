...
`plyranges` introduces the concept of _Grouped*Ranges_, this is a similiar idea
to the grouped data.frame in dplyr. Note that grouping does not change the 
...
We can think about finding overlaps as a type of join between two _*Ranges_
