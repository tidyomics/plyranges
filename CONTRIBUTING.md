...
This outlines how to propose a change to plyranges. For more detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("sa-lee/plyranges", fork = TRUE)`.
...
Please note that the plyranges project is released with a [Contributor
Code of
Conduct](https://tidyomics.github.io/plyranges/CODE_OF_CONDUCT.md). By
